...
public enum OutputOption implements Serializable {
	...
	RoiDrawMinBlank("ROIs on Blank Image (no text)", "RoiDrawMinBlank", 2, "BLANK ROIs NO TXT", 3),
	...
	BinDrawMinBlank("Bins on Blank Image (no text)", "BinDrawMinBlank", 2, "BLANK BINS NO TXT", 3),
